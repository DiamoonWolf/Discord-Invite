...
Public Class DiscordTextBox
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        G.FillPath(New SolidBrush(Color.FromArgb(72, 76, 82)), RoundRect(FullRectangle(Size, True), 1))
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Select Case State
            ...
            Case MouseState.Over
                ...
                G.FillPath(New SolidBrush(Color.FromArgb(103, 123, 196)), RoundRect(FullRectangle(Size, True), Height / 20))

            Case Else

                G.FillPath(New SolidBrush(Color.FromArgb(114, 137, 218)), RoundRect(FullRectangle(Size, True), Height / 20))

        End Select

        Using ButtonFont As New Font("Segoe UI", 9, FontStyle.Bold), Border As New Pen(Brushes.LightGray)

            CenterString(G, Text, ButtonFont, Color.White, FullRectangle(Size, False))
        End Using
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Select Case State
            ...
            Case MouseState.Over
                ...
                G.FillPath(New SolidBrush(Color.FromArgb(47, 49, 54)), RoundRect(FullRectangle(Size, True), Height / 20))

            Case Else

                G.FillPath(New SolidBrush(Color.FromArgb(41, 43, 47)), RoundRect(FullRectangle(Size, True), Height / 20))
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        If Enabled Then
            ...
            Using Background As New SolidBrush(Color.FromArgb(72, 76, 82)), Border As New Pen(Color.FromArgb(41, 43, 47)), TextColor As New SolidBrush(Color.FromArgb(220, 221, 222)), TextFont As New Font("Segoe UI", 9)
                ...
                G.DrawPath(Border, RoundRect(New Rectangle(0, 0, 16, 16), 1))
